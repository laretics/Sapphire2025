...
namespace TimeNetComponents.TreeView
{
	internal class PlanNode:TreeNode
	{
		...
		public PlanNode(Plan plan, TopoStorage topoStorage, Rauta rauta)
		{
		...
		public override string Name => string.Format("{0} ({1})", Plan.Name, Plan.Id);
		...
		public override List<TreeNode> Children
		{
			get
			{
				...
				salida.Add(new CirculationsNode(Plan,TopoStorage,Rauta,true));
				return salida;
			}
		}
