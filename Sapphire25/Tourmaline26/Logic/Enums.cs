...
namespace Tourmaline26.Logic
{
	public static class Enums
	{
        ...
        public enum PassengerInformationMode : byte
        {
            ...
            NextStopInfo = 3,   // TFT: cartel de correspondencias. LED int: próxima estación; parado en estación → destino y coche. LED ext: destino.
            Cruise = 4,         // TFT: stream Experience + mapa. LED int: hora/temp/vel. LED ext: número de tren (destino si parado en estación).
            EndOfTrip = 5       // TFT: mismo cartel de llegada. LED int: próxima estación; parado en estación → destino y coche. LED ext: destino.
        }
