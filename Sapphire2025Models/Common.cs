...
namespace Sapphire2025Models
{
	...
	{
		public static string SapphireSoftwareVersion => "26.07.25";
		public static bool MajorVersion => true; //Muestra el aviso de actualización sólo cuando este flag es true.
		public static string LastChangesText => "Vías de estacionamiento|Actualización de trenes|Mejoras de diseño";
